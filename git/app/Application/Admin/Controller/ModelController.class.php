...
class ModelController extends AdminController {
    ...
    public function add(){
        ...
        //挂载标签
        $this->assign('tags_category', D('TagsCategory','Logic')->getCheckbox('tags_category'));
        //挂载产品标签
        $this->assign('product_tags_category', D('ProductTagsCategory','Logic')->getCheckbox('product_tags_category'));
        $this->display();
    }
    ...
    public function edit(){
        ...
        //挂载标签
        $this->assign('tags_category', D('TagsCategory','Logic')->getCheckbox('tags_category', $data['tags_category']));
        //挂载产品标签
        $this->assign('product_tags_category', D('ProductTagsCategory','Logic')->getCheckbox('product_tags_category', $data['product_tags_category']));
