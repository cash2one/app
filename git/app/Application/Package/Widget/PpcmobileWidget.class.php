...
class PpcmobileWidget extends Controller{
   public function xsLibaoList(){
		...
		$where = array('category_rootid'=>'2');
		$whereMap = array('map' => array('category_rootid' => '2'));
        //分页获取数据
        $row = 10;
        ...
        $this->assign('SEO',$seo);
        //模板选择
        $this->display(T('Package@ppcmobile/Category/index'));
     ...
     */
     public function relatePackage($id){
	   ...
	   $this->display(T('Package@ppcmobile/Widget/relatePackage'));
		}
    /**
     * 最新发号信息
     * @return void
